...
namespace AddressBook
{
    ...
    {
        //Declaring a dictionary to store multiple contact with the help of key
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Enter the name of the adddress book: ");
                string bookName = Console.ReadLine();
                //creating object person1 of AddressBook class()
                addressBook person1 = new addressBook();
                Console.WriteLine("Enter the no of contacts you want to add in address book: ");
                ...
                {
                    Console.WriteLine("Address book is alredy exists");
                    return;
                }
                else
                {
